...
class ViaggiatoreAdmin(admin.ModelAdmin):
    ...
    list_display = ['name', 'player','secondaries', 'is_storyteller', 'has_bug','bug_list', 'indice', 'indice_attributes', 'indice_skills', 'color', 'destiny', 'protection_map']
    list_editable = ['color','secondaries', 'destiny','is_storyteller']
