   ...
   register(){
    ...
    drawAll(){
        ...
        let dataset = [
            ...
            {"idx": 3,"pts":1, "name":"Fluide", "svg":"cd_3.svg", "category": "Consistances Draconiques", "color": "#F0D080", "row":3, "hidden":1},
            {"idx": 4,"pts":2, "name":"Précipité", "svg":"cd_4.svg", "category": "Consistances Draconiques", "color": "#F0D080", "row":3, "hidden":1},
            {"idx": 5,"pts":2, "name":"Congestion", "svg":"cd_5.svg", "category": "Consistances Draconiques", "color": "#F0D080", "row":3, "hidden":1},
            {"idx": 6,"pts":2, "name":"Amas", "svg":"cd_6.svg", "category": "Consistances Draconiques", "color": "#F0D080", "row":3, "hidden":1},
            {"idx": 7,"pts":3, "name":"Cristal", "svg":"cd_7.svg", "category": "Consistances Draconiques", "color": "#F0D080", "row":3, "hidden":1},

            {"idx": 1,"pts":1, "name":"Ondée", "svg":"em_1.svg", "category": "Emanations Draconiques", "color": "#00D000", "row":4, "hidden":1},
            {"idx": 2,"pts":1, "name":"Flux", "svg":"em_2.svg", "category": "Emanations Draconiques", "color": "#00D000", "row":4, "hidden":1},
            {"idx": 3,"pts":1, "name":"Courant", "svg":"em_3.svg", "category": "Emanations Draconiques", "color": "#00D000", "row":4, "hidden":1},
            {"idx": 4,"pts":2, "name":"Vague", "svg":"em_4.svg", "category": "Emanations Draconiques", "color": "#00D000", "row":4, "hidden":1},
            {"idx": 5,"pts":2, "name":"Marée", "svg":"em_5.svg", "category": "Emanations Draconiques", "color": "#00D000", "row":4, "hidden":1},
            {"idx": 6,"pts":2, "name":"Ras", "svg":"em_6.svg", "category": "Emanations Draconiques", "color": "#00D000", "row":4, "hidden":1},
            {"idx": 7,"pts":3, "name":"Déferlante", "svg":"em_7.svg", "category": "Emanations Draconiques", "color": "#00D000", "row":4, "hidden":1},
...
//
        ...
        me.trump.append("text")
                ...
                .attr("width", me.step*4)
                .attr("height", me.step * 4)
                .attr("x", d => (5.5) * me.step)
                .attr("y", d => (1) * me.step)
                .style("text-anchor","middle")
                .style("font-family","Are You Serious")
                .style("font-size",me.step*0.6+"pt")
                .style("fill","#101010")
                .style("stroke","#808080")
                .style("stroke-width","0.25pt")
                .text(d => d['idx'])
